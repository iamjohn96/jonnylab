...
const apps: App[] = [
  ...
  },
  {
    ...
    tags: ["iOS", "Android", "Sleep", "Relaxation", "White Noise"],
    href: "/serenity",
    external: false,
  ...
  },
  {
    ...
    name: "Fileio",
    tagline: "Scan, organize, and privately manage documents on iPhone, iPad, and Android",
    tags: ["iOS", "Android", "PDF Tools", "Private Vault", "On-Device"],
    href: "/fileio",
    external: false,
    status: "Available on iOS & Android",
    statusGreen: true,
    ...
    },
    {
      ...
      },
      {
        ...
        item: {
          ...
          description: "An ambient sound and sleep sound mixer available on iPhone, iPad, and Android.",
        },
      },
      {
        "@type": "ListItem",
      ...
      },
      {
        ...
        item: {
          ...
          operatingSystem: "Android",
          applicationCategory: "UtilitiesApplication",
          description: "A privacy-first document and PDF workspace available on iPhone, iPad, and Android.",
        },
      },
      {
        "@type": "ListItem",
