...
const sections = [
  {
    title: "Overview",
    paragraphs: [
      "Fileio: File Manager & Scanner is a local file manager, document viewer, and document scanner for Android and iOS. Its file features operate on your device, and no Fileio account is required.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "You can use Reset App Data to delete files managed inside Fileio and the app's local metadata. Uninstalling Fileio may also remove app-specific stored data according to your operating system and device behavior. Keep separate copies of important files before resetting or uninstalling the app.",
    ],
  },
  {
    title: "Document and Photo Selection",
    paragraphs: [
      "Fileio uses operating-system document and photo pickers on Android and iOS. The app imports only files or images that you explicitly select and does not request broad access to your entire photo, video, or storage library.",
  ...
  },
  {
    ...
    paragraphs: [
      "Fileio displays no ads, includes no advertising SDK, and does not use advertising identifiers.",
  ...
  },
  {
    ...
    paragraphs: [
      "Fileio provides free core features and offers optional monthly and yearly Fileio Pro auto-renewable subscriptions. Purchases are processed by Apple App Store or Google Play. JonnyLab does not receive or store your full payment-card details.",
      "Fileio uses RevenueCat to present products, validate purchases, restore purchases, and determine Pro access. RevenueCat and the applicable app store may process a pseudonymous app user identifier, product identifiers, purchase and renewal status, transaction timestamps, country or store information, and diagnostic information necessary to provide subscriptions. They do not receive the contents of files imported, scanned, or stored in Fileio. Their own privacy policies apply to this processing.",
    ],
  },
  {
    title: "Security",
    paragraphs: [
      "Fileio is designed around local processing and minimum necessary access, including operating-system pickers instead of broad media or storage permissions. Private Vault files are encrypted locally, and the Vault automatically locks when you leave the app.",
