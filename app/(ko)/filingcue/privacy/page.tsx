...
const sections: PolicySection[] = [
  ...
  },
  {
    ...
    bullets: ["사용자 계정을 만들지 않습니다.", "로그인을 요구하지 않습니다.", "광고를 표시하지 않습니다.", "사용자 행동 분석이나 추적 도구를 사용하지 않습니다.", "관심기업과 읽음 상태는 기기 내부에만 저장합니다.", "구독 기능을 이용할 때 Google Play와 RevenueCat이 구매 내역과 익명 구매 서비스 식별자를 처리할 수 있습니다.", "사용자의 개인정보를 판매하지 않습니다."],
  },
  {
    title: "수집하지 않는 개인정보",
    paragraphs: ["FilingCue는 다음 정보를 직접 수집하거나 JonnyLab 서버로 전송하지 않습니다."],
    bullets: ["이름", "이메일 주소", "전화번호", "생년월일", "성별", "주소", "정확한 위치 또는 대략적인 위치", "연락처", "사진 및 동영상", "음성 또는 오디오", "문자 메시지 및 통화 기록", "금융계좌 정보", "신용카드 번호 또는 전체 결제수단 정보", "투자계좌 및 보유 종목", "개인 포트폴리오 정보", "광고 식별자", "기기 고유 식별자", "웹 검색 및 방문 기록", "다른 앱의 사용 기록", "건강 및 의료 정보", "생체정보"],
  ...
  {
    title: "개인정보 이용 목적",
    paragraphs: ["FilingCue는 필요한 정보만 최소한으로 처리합니다.", "기기 내부 정보와 구독 관련 정보는 다음 목적으로만 사용됩니다."],
    bullets: ["사용자가 선택한 관심기업 표시", "읽은 공시와 읽지 않은 공시 구분", "앱 환경설정 유지", "사용자 기기에서 앱 이용 경험 제공", "구독 구매와 상태 확인", "구매 복원", "부정 결제 방지와 결제 서비스 운영"],
    after: ["이 정보는 광고, 사용자 프로파일링, 신용평가, 투자 성향 분석 또는 제3자 마케팅에 사용되지 않습니다."],
  },
  {
    title: "개인정보의 제3자 제공 및 판매",
    paragraphs: ["JonnyLab은 FilingCue 사용자의 개인정보를 판매하지 않습니다.", "구독 기능을 제공하기 위해 Google Play Billing과 RevenueCat이 서비스 제공자로서 구매 내역, 구독 상태 및 익명 구매 서비스 식별자를 처리할 수 있습니다.", "이 정보는 광고 사업자나 데이터 중개업체에 판매되지 않으며, FilingCue는 RevenueCat에 이름, 이메일 주소, 전화번호 또는 자체 사용자 계정을 전송하지 않습니다."],
  },
  {
    title: "광고 및 사용자 추적",
  ...
  {
    title: "결제 및 구독",
    paragraphs: ["FilingCue는 Google Play Billing과 RevenueCat을 이용해 유료 구독을 제공하거나 내부 테스트할 수 있습니다.", "이 과정에서 구매 내역, 상품 식별자, 구매 및 구독 상태, 영수증 또는 구매 토큰, 익명 RevenueCat 고객 식별자가 구독 제공, 상태 확인, 구매 복원, 부정 사용 방지 및 서비스 운영을 위해 처리될 수 있습니다.", "Google Play가 결제수단 정보를 직접 처리하므로 JonnyLab과 FilingCue는 사용자의 신용카드 번호나 전체 결제수단 정보를 직접 수집하거나 보관하지 않습니다.", "RevenueCat은 구독 서비스 운영을 위해 구매 관련 정보를 국외 서버에서 처리하고 보관할 수 있습니다."],
  },
  {
    title: "외부 서비스와 링크",
  ...
  },
  {
    ...
    paragraphs: ["FilingCue는 Google Play를 통해 배포됩니다.", "Google은 앱 설치, 업데이트, 기기 호환성, 결제 또는 Play 서비스 운영 과정에서 일부 정보를 처리할 수 있습니다. 이러한 처리는 Google의 개인정보처리방침과 Google Play 정책에 따릅니다.", "RevenueCat은 Google Play 구매 내역과 익명 구매 서비스 식별자를 처리하여 구독 상태 확인과 구매 복원을 제공합니다.", "JonnyLab은 FilingCue 앱에 자체 광고, 행동 분석 또는 사용자 추적 SDK를 포함하지 않습니다."],
  },
  {
    title: "데이터 보유 기간",
    paragraphs: ["기기 내부에 저장되는 관심기업, 읽음 상태 및 환경설정은 다음 시점까지 보관될 수 있습니다."],
    bullets: ["사용자가 해당 정보를 삭제할 때", "앱 데이터를 초기화할 때", "FilingCue 앱을 삭제할 때"],
    after: ["JonnyLab은 사용자 계정이나 사용자별 앱 이용 데이터를 자체 서버에 보관하지 않습니다.", "구매 및 구독 관련 정보는 Google Play와 RevenueCat의 정책, 법적 의무 및 서비스 운영에 필요한 기간 동안 보관될 수 있습니다."],
  },
  {
    title: "데이터 보안",
  ...
  {
    title: "이용자의 권리",
    paragraphs: ["FilingCue는 사용자 계정이나 서버 기반 사용자 프로필을 생성하지 않습니다.", "사용자는 기기 설정 또는 앱 기능을 통해 로컬 데이터를 확인하거나 삭제할 수 있습니다.", "구매 서비스에 저장된 데이터의 확인 또는 삭제를 요청하려면 support@jonnylab.app으로 연락할 수 있습니다. JonnyLab은 식별 가능한 범위에서 RevenueCat 삭제 절차를 진행하거나 해당 제공자의 절차를 안내합니다.", "관계 법령, 회계·결제 의무 또는 Google Play와 같은 독립적인 제공자의 정책에 따라 일부 거래 기록은 삭제 요청 후에도 보관될 수 있습니다."],
  },
  {
    title: "개인정보의 국외 이전",
    paragraphs: ["JonnyLab은 관심기업, 읽음 상태 및 앱 환경설정을 해외 서버로 전송하지 않습니다.", "구독 기능을 이용하면 RevenueCat, Inc.가 구매 또는 복원 시 구매 내역, 구독 상태 및 익명 구매 서비스 식별자를 암호화된 통신 방식으로 미국에 전송하여 처리할 수 있습니다. RevenueCat 문의처는 compliance@revenuecat.com입니다.", "처리 목적은 구독 제공, 상태 확인, 구매 복원, 분석 및 서비스 운영이며, 해당 정보는 RevenueCat의 처리 정책과 관련 법령에 따라 서비스 제공 및 법적 의무 이행에 필요한 기간 동안 보관될 수 있습니다.", "구독 관련 처리를 원하지 않는 사용자는 유료 구독을 구매하지 않고 FilingCue의 무료 기능을 이용할 수 있습니다."],
  },
  {
    title: "개인정보처리방침의 변경",
    ...
    bullets: ["사용자 계정", "서버 동기화", "알림 서버", "사용자 분석", "광고", "실제 사용자 행동 데이터 수집", "새로운 외부 데이터 처리 서비스"],
