...
const sections = [
  ["서비스 제공자", ["Deadline Lens는 JonnyLab이 제공합니다. 앱은 선택형 일회성 구매를 제공, 처리 및 복원하기 위해 Google Play와 RevenueCat을 사용합니다. 본 방침에 관한 문의는 support@jonnylab.app으로 보내실 수 있습니다."]],
  ["적용 대상", ["본 개인정보처리방침은 Android 앱 Deadline Lens(패키지명: com.jonnylab.deadlinelens)에 적용됩니다."]],
  ["수집하는 개인정보", ["Deadline Lens는 문서 이미지, OCR 텍스트, 저장된 마감일 또는 알림 내용을 JonnyLab 서버로 수집하거나 전송하지 않습니다."]],
  ["수집하지 않는 정보", ["Deadline Lens는 광고 식별자, 위치, 연락처, 건강 정보, 금융 계좌 정보, 문서 이미지, OCR 텍스트, 저장된 마감일 또는 광고를 위한 이용 행동 정보를 수집하지 않습니다. 결제 정보는 Google Play에서 처리하며, Deadline Lens는 카드 또는 은행 계좌 정보를 받지 않습니다."]],
  ...
  ["데이터 전송", ["문서 이미지, OCR 텍스트 및 일정 정보는 기기 밖으로 나가지 않습니다. 앱은 구매 제공, 결제 또는 영수증 상태, 이용 권한 갱신 및 구매 복원을 위해서만 Google Play와 RevenueCat에 연결됩니다. 클라우드 동기화나 클라우드 백업을 제공하지 않습니다."]],
  ["구매 및 RevenueCat", ["결제는 Google Play에서 처리합니다. RevenueCat은 구매 제공, 검증, 복원 및 지원에 필요한 익명 앱 사용자 식별자, 구매·거래 및 영수증 데이터, 이용 권한 상태 및 제한된 기기 기술 정보를 처리할 수 있습니다. Deadline Lens는 문서 이미지, OCR 텍스트, 저장된 마감일 또는 알림 내용을 RevenueCat에 전송하지 않습니다. 앱에서 사용자 계정을 만들지 않습니다."]],
  ["광고, 분석 및 추적", ["Deadline Lens에는 광고 SDK, 광고 추적 또는 이용 행동 분석 서비스가 없으며 광고 식별자를 요청하지 않습니다. 구매 기능에는 위에 설명한 Google Play 및 RevenueCat 서비스 데이터가 포함됩니다."]],
  ["제3자 기술 사용", ["Deadline Lens는 기기 내 텍스트 인식을 위한 Google ML Kit과 선택형 일회성 구매를 위한 Google Play 및 RevenueCat을 사용합니다. 앱은 OCR을 위해 사용자의 문서나 OCR 결과를 외부 서버로 전송하지 않습니다. Android 운영체제, 시스템 카메라 앱 및 시스템 이미지 선택기는 플랫폼 또는 사용자가 선택한 앱의 정책에 따라 자체적인 처리를 할 수 있습니다."]],
  ["데이터 보관 및 삭제", ["저장된 마감일은 사용자가 앱에서 삭제하거나 앱 데이터를 제거할 때까지 기기에 남아 있습니다. Deadline Lens에서 저장된 항목을 개별적으로 삭제할 수 있습니다. 앱을 삭제하면 Android 운영체제의 일반적인 앱 제거 절차에 따라 로컬 앱 데이터도 삭제됩니다.", "RevenueCat이 보관하는 구매 데이터의 삭제를 요청하려면 사용자가 확인할 수 있는 Google Play 주문 정보와 함께 support@jonnylab.app으로 문의해 주세요. 요청을 찾고 처리하는 용도로만 사용합니다."]],
  ...
  ["보안 조치", ["Deadline Lens는 문서를 기기에서 처리하고, 저장 항목을 로컬에 보관하며, Android 앱 백업을 비활성화하고, 네트워크 사용을 위에서 설명한 구매 및 복원 목적으로만 제한하는 방식으로 데이터 노출 가능성을 줄입니다. 어떠한 기기 저장 방식도 위험이 전혀 없다고 보장할 수 없으므로 사용자는 자신의 기기 접근을 보호해야 합니다."]],
  ...
  ["시행일", ["본 개인정보처리방침은 2026년 8월 28일부터 시행하며, 최종 업데이트 날짜는 2026년 9월 12일입니다."]],
] as const;
